...
export async function ExportPayrollToExcel(exportedData: any) {
  try {
    ...
    console.log('Original allowanceTypes count:', allowanceTypes.length);
    console.log('Unique allowanceTypes count:', uniqueAllowanceTypes.length);
    console.log('Original deductionTypes count:', deductionTypes.length);
    console.log('Unique deductionTypes count:', uniqueDeductionTypes.length);
    console.log('Original contributionTypes count:', contributionTypes.length);
    console.log(
      'Unique contributionTypes count:',
      uniqueContributionTypes.length
    );
