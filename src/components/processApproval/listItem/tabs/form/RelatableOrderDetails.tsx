...
function RelatableOrderDetails({
  order,
  toggleOpen,
}: RelatableOrderDetailsProps) {
    ...
    <>
      <DialogContent>
        ...
        <Grid container spacing={1} sx={{ mt: 2, mb: 3 }}>
          <Grid size={{ xs: 12 }} sx={{ textAlign: 'center' }}>
            <Typography variant='body2' color={mainColor} sx={{ p: '5px' }}>
              SUPPLIER
            </Typography>
            <Divider />
              ...
              <TableBody>
                {order.purchase_order_items.map((orderItem, index) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {orderItem.product.name || orderItem.product.item_name}
                    </TableCell>
