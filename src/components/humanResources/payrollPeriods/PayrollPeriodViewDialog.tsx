    ...
    (sum, entry) => {
      ...
      return {
        ...
        allowanceByType: sum.allowanceByType?.map(
          (value: any, index: any) => value + allowanceByType?.[index]
        ),
        preTaxDeductionByType: sum.preTaxDeductionByType.map(
          (value: any, index: any) => value + preTaxDeductionByType?.[index]
        ),
        postTaxDeductionByType: sum.postTaxDeductionByType.map(
          (value: any, index: any) => value + postTaxDeductionByType?.[index]
        ),
        contributionByType: sum.contributionByType.map(
          (value: any, index: any) => value + contributionByType?.[index]
        ),
      };
    },
    {
...
export default PayrollPeriodViewDialog;
