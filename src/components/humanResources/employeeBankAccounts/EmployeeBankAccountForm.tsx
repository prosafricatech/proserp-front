...
const EmployeeBankAccountForm = ({
  ...
  const {
    ...
    onError: (mutationError) => {
      ...
      console.log('error adding employee bank account: ', mutationError);
    },
  });
  ...
  const {
    ...
    onError: (mutationError) => {
      ...
      console.log('error updating employee bank account: ', mutationError);
    },
  });
    ...
    <>
      <DialogTitle>
        <Grid size={12} textAlign={'center'}>
          {!account?.id ? 'Add Employee Bank Account' : 'Edit Employee Bank Account'}
        </Grid>
      </DialogTitle>
      <DialogContent>
