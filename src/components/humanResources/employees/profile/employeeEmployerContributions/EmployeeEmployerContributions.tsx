...
const EmployeeEmployerContributions = ({ employeeId }: { employeeId?: number }) => {
  ...
  const renderEmployeeEmployerContributions = React.useCallback(
    (employeeEmployerContribution: EmployeeEmployerContributionType) => {
      return (
        <EmployeeEmployerContributionsListItem
  ...
  useEffect(() => {
    setQueryOptions((state) => ({
      ...
      queryParams: {
        ...state.queryParams,
        employee_id: resolvedEmployeeId,
        keyword: getSanitizedSearchKeyword('Employee Employer Contributions', searchParams),
      },
    }));
    setMounted(true);
  ...
  return (
    <JumboRqList
      ...
      service={humanResourcesServices.getEmployeeEmployerContributionsList}
      primaryKey='id'
      queryOptions={queryOptions}
      itemsPerPage={10}
      itemsPerPageOptions={[10, 20, 30, 50]}
      renderItem={renderEmployeeEmployerContributions}
        ...
        <JumboListToolbar
          ...
          actionTail={
            <Stack direction='row'>
              ...
              />
              <EmployeeEmployerContributionActionTail employeeId={resolvedEmployeeId} />
            </Stack>
          }
        ></JumboListToolbar>
      }
...
export default EmployeeEmployerContributions;
