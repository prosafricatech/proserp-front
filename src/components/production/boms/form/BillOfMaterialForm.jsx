import {  
  ...
  FormControl, Grid, IconButton, MenuItem, Select, TextField, 
  Tooltip, Typography 
} from '@mui/material'
...
function BillOfMaterialForm({ toggleOpen, billOfMaterial }) {
  ...
  const [selectedUnit, setSelectedUnit] = useState(
    billOfMaterial && (billOfMaterial.measurement_unit_id ? billOfMaterial.measurement_unit_id : billOfMaterial.measurement_unit.id)
  );
  ...
  const saveMutation = billOfMaterial ? updateBillOfMaterial : addBillOfMaterial;
