...
function FuelVouchersItemRow({ fuelVoucher, index, productPrices }) {
  ...
  const { fuelVouchers = [], setFuelVouchers } = useFormContext();
    ...
    <React.Fragment>
      ...
      {!showForm ? (
        ...
        >
          ...
          <Grid
            size={{ xs: 6, md: !!expense_ledger ? 3.5 : 5, lg: !!expense_ledger ? 2 : 2.5 }}
          >
