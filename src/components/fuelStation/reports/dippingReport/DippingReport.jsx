...
function DippingReport() {
  ...
  const { data: stations, isFetching: isFetchingStation } = useQuery(['userStations', {
      userId: authUser?.user?.id,
  }], fuelStationServices.getUserStations);
      ...
      <DialogTitle textAlign={'center'}>
        <Grid container>
          <Grid item xs={12} mb={2}>
            <Typography variant="h3">Dipping Report</Typography>
          </Grid>
        </Grid>
