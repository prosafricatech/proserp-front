...
function ProjectInventoryValuePDF({
  organization,
  project,
  currencyCode,
  rows,
  ...
  return (
    <Document
      title={`Project Inventory Value Summary | ${organizationName}`}
      author={organizationName}
      subject='Project Inventory Value Summary'
...
export default ProjectInventoryValuePDF;
